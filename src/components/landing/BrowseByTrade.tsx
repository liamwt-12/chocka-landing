          ...
          <div className="flex overflow-x-auto gap-3 pb-2 md:grid md:grid-cols-4 lg:grid-cols-5 md:overflow-visible md:pb-0">
            {TRADES.map((trade) => (
              <Link
                ...
                className="flex-shrink-0 w-[160px] md:w-auto bg-white rounded-xl px-4 py-4 flex items-center gap-3 border border-soft/15 hover:border-orange/30 hover:shadow-md transition-all group"
              >
