...
export default function NicheSMSMockup({
  views,
  viewsChange,
  calls,
  callsChange,
              ...
              <div className="bg-white/10 rounded-2xl rounded-tl-md p-5 text-sm text-white/80 leading-relaxed">
                ...
                <div className="space-y-1 font-mono text-xs">
                  <p>
                    ...
                    <span className="text-emerald-400">↑ {viewsChange}</span>
                  </p>
                  <p>
                    Calls: <span className="text-white font-bold">{calls}</span>{' '}
                    <span className="text-emerald-400">↑ {callsChange}</span>
                  </p>
                  <p>
                    Local ranking:{' '}
                    <span className="text-white font-bold">{ranking}</span>{' '}
                    <span className="text-emerald-400">↑ {rankingChange}</span>
                  </p>
                  <p>
                    Star rating:{' '}
                    <span className="text-white font-bold">{starRating}</span>
                  </p>
                </div>
