      ...
      <section className="py-20 md:py-28 px-6 md:px-12 lg:px-20">
        <div className="container-max max-w-4xl mx-auto">
          <h2 className="font-heading font-extrabold text-3xl md:text-4xl text-white mb-4 text-center">
            This is what your profile looks like to Google right now
          </h2>
          ...
          <div className="grid md:grid-cols-[1fr,auto,1fr] gap-6 items-center">
            ...
            <div className="bg-[#1a1a1a] rounded-2xl p-8 border border-red-500/20">
              ...
              <ul className="space-y-2 text-white/40 text-sm">
                <li className="flex items-center gap-2">
                  <span className="text-red-400">✕</span> No posts
                </li>
                <li className="flex items-center gap-2">
                  <span className="text-red-400">✕</span> No replies
                </li>
                <li className="flex items-center gap-2">
                  <span className="text-red-400">✕</span> Incomplete profile
                </li>
              </ul>
            </div>
            ...
            <div className="bg-[#1a1a1a] rounded-2xl p-8 border border-emerald-500/20">
              ...
              <ul className="space-y-2 text-white/60 text-sm">
                <li className="flex items-center gap-2">
                  <span className="text-emerald-400">✓</span> Weekly posts
                </li>
                <li className="flex items-center gap-2">
                  <span className="text-emerald-400">✓</span> All reviews
                  replied
                </li>
                <li className="flex items-center gap-2">
                  <span className="text-emerald-400">✓</span> Fully optimised
                </li>
              </ul>
            </div>
          </div>
